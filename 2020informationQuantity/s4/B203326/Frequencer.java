package s4.B203326;  // ここは、かならず、自分の名前に変えよ。
import java.lang.*;
...
public class Frequencer implements FrequencerInterface{
    ...
    byte [] myTarget; //検索する文字列
    byte [] mySpace; //検索される文字列
    ...
    // The following is the code to print the contents of suffixArray.(以下のコードは、suffixArrayの内容を出力するコード)
    ...
    private int suffixCompare(int i, int j) {
        ...
        // When mySpace is "ABCD", suffix_0 is "ABCD", suffix_1 is "BCD", suffix_2 is "CD", and sufffix_3 is "D".
        // Each i and j denote suffix_i, and suffix_j.                            
        // Example of dictionary order(例)                                            
        // "i"      <  "o"        : compare by code                              
    ...
    private int targetCompare(int i, int j, int k) {
        ...
        //target_j_kは、myTargetの文字列で、j番目の位置から始まり、k番目の位置で終わります。

        // if myTarget is "ABCD", 
        //     j=0, and k=1 means that target_j_k is "A".
        //     j=1, and k=3 means that target_j_k is "BC".

        // This method compares suffix_i and target_j_k.(このメソッドは、suffix_iとtarget_j_kを比較)
        // if the beginning of suffix_i matches target_j_k, it return 0. (サフィックス_iの先頭がtarget_j_kと一致する場合、0を返し)
        // if suffix_i > target_j_k it return 1; 
        // if suffix_i < target_j_k it return -1;
        // if first part of suffix_i is equal to target_j_k, it returns 0;(suffix_iの最初の部分がtarget_j_kと等しい場合、0を返します。)
        //
        // Example of search 
        // suffix          target
        // "o"       >     "i"
        ...
        // For example,
        //    if suffix_i is "Ho Hi Ho", and target_j_k is "Ho", (suffix_i == "Ho Hi Ho", target_j_k == "Ho")
